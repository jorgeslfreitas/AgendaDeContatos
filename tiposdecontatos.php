...
<html lang="pt-br">
  ...
  <body>
      <div class="container">
          ...
          <a href="tipodecontato.php?idTipoContato=0" target="target">
              ...
              <tbody>
                  <?php
                    ...
                    foreach ($retornoDaConsulta as $registro){
                        ...
                        $qtdTipoContato = utf8_encode($registro ["NumeroTipoContato(IDTIPOCONTATO)"]);
                  ?>
                  <tr>
                      <th scope="row"><?php echo $idTipoContato; ?></th>
                      <td><?php echo $nome; ?></td>
                      <td><?php echo $qtdTipoContato; ?></td>
                      <td>
                          <a href="tipodecontato.php?idTipoContato=<?php echo $idTipoContato; ?>" target="target">
                              <button type="button" class="btn btn-warning">Alterar</button>
                          </a>
                      </td>
                      <td>
                          <a href="excluirtipodecontato.php?idTipoContato=<?php echo $idTipoContato; ?>" target="target">
